...
module.exports.bootstrap = async function () {
  ...
  await Company.createEach([
    { name: 'Infosys Limited Pune', address: 'Plot No. 1, Hinjawadi Phase II, Hinjewadi Rajiv Gandhi Infotech Park, Hinjawadi, Pune, Maharashtra 411057' },
    { name: 'Infosys Phase 1 Building 1', address: 'Taluka Mulshi, Plot No. 1, Pune, Phase 1, Hinjewadi Rajiv Gandhi Infotech Park, Hinjawadi, Pune, Maharashtra 411057' },
    { name: 'Infosys Phase 1 Building 1', address: 'Taluka Mulshi, Plot No. 1, Pune, Phase 1, Hinjewadi Rajiv Gandhi Infotech Park, Hinjawadi, Pune, Maharashtra 411057', deleted: true },
  ]);
