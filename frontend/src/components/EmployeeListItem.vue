  ...
  <div>
    <div class="card is-hoverable employee-card">
      <header class="card-header">
        ...
        <button class="card-header-icon has-text-link has-tooltip-top" aria-label="Deactivate User"
          data-tooltip="Deactivate" @click="deactivateUser()">
          <span class="icon ">
            <i class="ri-archive-line"></i>
          </span>
        </button>
        <button class="card-header-icon has-text-link has-tooltip-top " data-tooltip="Edit User" aria-label="Edit User"
          @click="toggleEmployeeUpdateModal()">
          <span class="icon ">
            <i class="ri-edit-box-line"></i>
          </span>
        </button>
        <button class="card-header-icon has-text-danger has-tooltip-top" data-tooltip="Delete User"
          aria-label="Delete User" @click="deleteUser()">
          <span class="icon ">
            <i class="ri-delete-bin-line"></i>
          </span>
        </button>
        <button class="card-header-icon has-text-danger has-tooltip-top" data-tooltip="Unlink Company"
          aria-label="Unlink Company" v-if="employee.company" @click="unlinkEmployee()">
          <span class="icon ">
